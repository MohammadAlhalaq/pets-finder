...
parcelRequire = (function(e, r, t, n) {
...
})(
  {
      ...
      function(require, module, exports) {
        ...
        function Fl(e, n, l) {
          ...
          for (var a in (i = i.getChildContext()))
            if (!(a in e)) throw Error(r(108, D(n) || "Unknown", a));
          return t({}, l, {}, i);
        }
        function Ol(e) {
          return (
                      ...
                      "children" === u
                        ? "string" == typeof c
                          ...
                          : "number" == typeof c &&
                            i.textContent !== "" + c &&
                            (e = ["children", "" + c])
                        : j.hasOwnProperty(u) && null != c && mn(l, u);
                    }
                  switch (a) {
                    case "input":
                      Te(i), Ne(i, o, !0);
        ...
        function Su(e, t) {
          ...
          var n = Tu(e);
          if (0 !== n) {
            if (((t = e.callbackNode), (Yo & (Wo | Qo)) !== Ao))
              throw Error(r(327));
        ...
        function Cu(e) {
          var t = e.lastExpiredTime;
          if (((t = 0 !== t ? t : 1073741823), (Yo & (Wo | Qo)) !== Ao))
            throw Error(r(327));
    ...
    S1cf: [
      ...
      { "./helpers/bind": "EDTP", "is-buffer": "qZlO" }
    ],
    M8l6: [
      function(require, module, exports) {
        "use strict";
    ...
    R7zu: [
      function(require, module, exports) {
        const e = require("axios"),
          ...
          n = (n, s = {}) => e.get(`${o}${n}`, { params: s }).then(t, r);
        module.exports = {
          animals: e => n("animals", e),
          animal: e => n(`animals/${e}`),
          types: () => n("types"),
          type: e => n(`types/${e}`),
          breeds: e => n(`types/${e}/breeds`),
          organizations: e => n("organizations", e),
          organization: e => n(`organizations/${e}`),
          requestLink(e, o) {
            let t = e;
            return e.startsWith("/v2/") && (t = e.replace("/v2/", "")), n(t, o);
          }
        };
      },
      { axios: "dZBD" }
    ...
    bLMO: [
      function(require, module, exports) {
        ...
        const a = (t, r, a) => {
          const [n, l] = (0, e.useState)(r),
            o = `use-dropdown-${t.replace("", "").toLowerCase()}`;
          return [
            () =>
              e.default.createElement(
                ...
                e.default.createElement(
                  "select",
                  {
                    ...
                    id: o,
                    value: n,
                    onBlur: ({ target: { value: e } }) => l(e),
                    onChange: ({ target: { value: e } }) => l(e),
                    disabled: !a.length
                  },
                  e.default.createElement("option", { value: "all" }, "All"),
                  a.map(t =>
                    e.default.createElement("option", { value: t, key: t }, t)
                  )
                )
              ),
            n,
    ...
    NmbE: [
      function(require, module, exports) {
        ...
        function y(e, n) {
            ...
            c = (function(t) {
              function e() {
                ...
                for (var r = arguments.length, i = Array(r), u = 0; u < r; u++)
                  i[u] = arguments[u];
                return (
                  (n = o = a(this, t.call.apply(t, [this].concat(i)))),
                  (o.emitter = v(o.props.value)),
                  a(o, n)
                );
              }
              return (
          ...
          c.childContextTypes =
            (((r = {})[s] = o.default.object.isRequired), r);
          var y = (function(t) {
            function n() {
              var e, o;
              p(this, n);
          ...
          return (
            (y.contextTypes = (((u = {})[s] = o.default.object), u)),
            { Provider: c, Consumer: y }
          );
        }
        (exports.default = y), (module.exports = exports.default);
      },
      { react: "n8MK", "prop-types": "D9Od", gud: "bHnc", warning: "XOCG" }
    ],
    EFM4: [
      function(require, module, exports) {
        "use strict";
        ...
        (exports.default = t.default.createContext || u.default),
          (module.exports = exports.default);
      },
      { react: "n8MK", "./implementation": "NmbE" }
    ],
    nkXc: [
      function(require, module, exports) {
        "use strict";
      ...
      function(require, module, exports) {
        ...
        var n = function(e, t) {
          for (
            ...
            var l = !1,
              v = c[f].route;
            if (v.default) o = { route: v, params: {}, uri: t };
            else {
              for (
                var d = b(v.path),
                  x = {},
                  m = Math.max(a.length, d.length),
                  g = 0;
                g < m;
                g++
              ) {
              ...
              if (!l) {
                n = { route: v, params: x, uri: "/" + a.slice(0, g).join("/") };
                break;
              }
            }
          }
          ...
          n = function(n, r) {
            ...
            return {
              ...
              listen: function(t) {
                o.push(t);
                var r = function() {
                  (a = e(n)), t({ location: a, action: "POP" });
                };
                return (
                  n.addEventListener("popstate", r),
                  function() {
                    n.removeEventListener("popstate", r),
              ...
              navigate: function(r) {
                var c =
                  ...
                  h = c.replace,
                  p = void 0 !== h && h;
                if ("number" == typeof r) n.history.go(r);
                else {
                  u = t({}, u, { key: Date.now() + "" });
                  try {
                    i || p
                      ? n.history.replaceState(u, null, r)
                      : n.history.pushState(u, null, r);
                  } catch (v) {
    ...
    VJZj: [
      function(require, module, exports) {
        ...
        var b = (function(t) {
          function r() {
            ...
            for (var o = arguments.length, a = Array(o), i = 0; i < o; i++)
              a[i] = arguments[i];
            return (
              (e = n = h(this, t.call.apply(t, [this].concat(a)))),
        ...
        (exports.LocationProvider = b),
          (b.defaultProps = { history: i.globalHistory });
        var g = function(t) {
          var r = t.url,
            n = t.children,
            o = r.indexOf("?"),
            ...
            i = "";
          return (
            o > -1 ? ((a = r.substring(0, o)), (i = r.substring(o))) : (a = r),
            e.default.createElement(
              m.Provider,
              {
                value: {
            ...
            (r.prototype.render = function() {
              ...
              if (v) {
                ...
                var P = l({}, m, {
                  ...
                  C = e.default.cloneElement(
                    g,
                    P,
                    g.props.children
                      ? e.default.createElement(
                          w,
                          { location: r, primary: i },
                          g.props.children
                        )
                      : void 0
                  ),
                  O = i ? E : c,
                  M = i ? l({ uri: y, location: r, component: c }, f) : f;
                return e.default.createElement(
                  x.Provider,
                  { value: { baseuri: y, basepath: o } },
        ...
        var C = v("Focus"),
          E = function(t) {
            ...
            return e.default.createElement(C.Consumer, null, function(t) {
              return e.default.createElement(
                j,
                l({}, a, { component: o, requestFocus: t, uri: r, location: n })
              );
            });
          },
          O = !0,
          ...
          j = (function(t) {
            ...
            return (
              ...
              (r.getDerivedStateFromProps = function(e, t) {
                if (null == t.uri) return l({ shouldFocus: !0 }, e);
                var r = e.uri !== t.uri,
                  n =
                    t.location.pathname !== e.location.pathname &&
                    e.location.pathname === e.uri;
                return l({ shouldFocus: r || n }, e);
              }),
              (r.prototype.componentDidMount = function() {
                M++, this.focus();
              }),
          ...
          return e.default.createElement(x.Consumer, null, function(t) {
            ...
            return e.default.createElement(y, null, function(t) {
              ...
              return e.default.createElement(
                "a",
                l(
                  { ref: r || n, "aria-current": g ? "page" : void 0 },
                  m,
                  v({
                    isCurrent: g,
            ...
            return (
              ...
              (t.prototype.componentDidMount = function() {
                ...
                Promise.resolve().then(function() {
                  ...
                  t((0, a.insertParams)(e, s), { replace: o, state: i });
                });
              }),
          ...
          T = function(t) {
            return e.default.createElement(x.Consumer, null, function(r) {
              ...
              return e.default.createElement(y, null, function(r) {
                return e.default.createElement(D, l({}, r, { baseuri: n }, t));
              });
            });
          };
        exports.Redirect = T;
          ...
          return e.default.createElement(x.Consumer, null, function(t) {
            ...
            return e.default.createElement(y, null, function(e) {
              ...
              return n({
                navigate: t,
                location: i,
                match: s ? l({}, s.params, { uri: s.uri, path: r }) : null
              });
            });
          });
        };
        ...
        var A = function(e) {
          ...
          K = function t(n) {
            return function(o) {
              if (!o) return null;
              if (o.type === e.default.Fragment && o.props.children)
                return e.default.Children.map(o.props.children, t(n));
              if (
                (o.props.path ||
                  o.props.default ||
                  o.type === T ||
                  (0, r.default)(!1),
                o.type !== T ||
                  (o.props.from && o.props.to) ||
                  (0, r.default)(!1),
                o.type !== T ||
                  (0, a.validateRedirect)(o.props.from, o.props.to) ||
                  (0, r.default)(!1),
                o.props.default)
              )
                return { value: o, default: !0 };
    ...
    EcQx: [
      function(require, module, exports) {
        ...
        function l({
          ...
          let i = "http://placecorgi.com/300/300";
          return (
            n.length && (i = n[0].small),
            e.default.createElement(
              t.Link,
              { to: `details/${u}`, className: "pet" },
              e.default.createElement(
                "div",
                { className: "image-container" },
                e.default.createElement("img", { src: i, alt: l })
              ),
              e.default.createElement(
                "div",
                { className: "info" },
                e.default.createElement("h1", null, l),
                e.default.createElement("h2", null, `${a} - ${r} - ${c}`)
              )
            )
          );
        }
      },
      { react: "n8MK", "@reach/router": "VJZj" }
    ],
    tKTj: [
      function(require, module, exports) {
        "use strict";
        ...
        const d = ({ pets: a }) =>
          e.default.createElement(
            ...
            { className: "search" },
            0 === a.length
              ? e.default.createElement("h1", null, "NO Pets Found")
              : a.map(a =>
                  e.default.createElement(t.default, {
                    ...
                    breed: a.breed,
                    media: a.photos,
                    location: `${a.contact.address.city}, ${a.contact.address.state}`,
                    id: a.id
                  })
                )
          );
    ...
    oLoL: [
      function(require, module, exports) {
        ...
        var e = o(require("react")),
          t = o(require("@frontendmasters/pet")),
          a = n(require("./DropDown")),
          r = n(require("./Results")),
          l = n(require("./ThemeContext"));
        function n(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function u() {
        ...
        function o(e) {
          ...
          for (var l in e)
            if (Object.prototype.hasOwnProperty.call(e, l)) {
              var n = r ? Object.getOwnPropertyDescriptor(e, l) : null;
              n && (n.get || n.set)
                ? Object.defineProperty(a, l, n)
                : (a[l] = e[l]);
            }
          return (a.default = e), t && t.set(e, a), a;
        }
        const c = () => {
          const [n, u] = (0, e.useState)(""),
            [o, c] = (0, a.default)("animal", "dog", t.ANIMALS),
            [f, d] = (0, e.useState)([]),
            [i, s] = (0, e.useState)([]),
            [m, p] = (0, e.useContext)(l.default),
            [v, b, y] = (0, a.default)("Breed", "", f);
          return (
            (0, e.useEffect)(() => {
              d([]),
                y(""),
                t.default.breeds(c).then(({ breeds: e }) => {
              ...
              e.default.createElement(
                "form",
                {
                  onSubmit: e => {
                    e.preventDefault(),
                      (async function() {
                        const { animals: e } = await t.default.animals({
                          location: n,
                          breed: b,
                          type: c
                        });
                ...
                e.default.createElement(
                  ...
                  e.default.createElement("input", {
                    type: "text",
                    value: n,
                    onChange: ({ target: { value: e } }) => u(e),
                    placeholder: "Location",
                    id: "location"
                  }),
                  e.default.createElement(o, null),
                  e.default.createElement(v, null),
                  e.default.createElement(
                    "label",
                    { htmlFor: "theme" },
                    "Theme",
                ...
                e.default.createElement(
                  "button",
                  { style: { backgroundColor: m }, type: "submit" },
                  "Submit"
                )
              ),
              e.default.createElement(r.default, { pets: i })
            )
          );
        };
        var f = c;
    ...
    a8IE: [
      function(require, module, exports) {
        ...
        class r extends e.default.Component {
          constructor(...e) {
            super(...e),
              a(this, "state", { photos: [], active: 0 }),
              a(
                this,
                "handleIndexClick",
                ({
          ...
          static getDerivedStateFromProps({ media: e }) {
            let t = ["http://placecorgi.com/600/600"];
            return e.length && (t = e.map(({ large: e }) => e)), { photos: t };
          }
          render() {
            const { photos: t, active: a } = this.state;
            return e.default.createElement(
              "div",
              { className: "carousel" },
              e.default.createElement(
                "div",
                { className: "carousel" },
                e.default.createElement("img", { src: t[a], alt: "animal" }),
                e.default.createElement(
                  "div",
    ...
    Vlsp: [
      function(require, module, exports) {
        ...
        class i extends e.Component {
          constructor(...e) {
            super(...e), n(this, "state", { hasError: !1, redirect: !1 });
          }
          ...
          componentDidUpdate() {
            setTimeout(() => this.setState({ redirect: !0 }), 5e3);
          }
          render() {
            return this.state.redirect
              ? e.default.createElement(r.Redirect, { to: "/" })
              : this.state.hasError
              ? e.default.createElement(
                  "h1",
                  null,
                  "there is error with this listining. ",
                  e.default.createElement(r.Link, { to: "/" }, "Click Here"),
                  " to back to the home page or wait five seconed"
                )
              : this.props.children;
          }
        }
    ...
    DtdL: [
      function(require, module, exports) {
        ...
        const u = document.getElementById("modal"),
          o = ({ children: r }) => {
            ...
            return (
              ...
              (0, e.useEffect)(
                () => (
                  u.appendChild(n.current), () => u.removeChild(n.current)
                ),
                []
              ),
              (0, t.createPortal)(
                e.default.createElement("div", null, r),
                n.current
              )
            );
          };
    ...
    XGSj: [
      function(require, module, exports) {
        ...
        var e = u(require("react")),
          t = u(require("@frontendmasters/pet")),
          l = u(require("./Carousel")),
          a = u(require("./ErrorBoundary")),
          r = u(require("./ThemeContext")),
          o = u(require("./Modal")),
          n = require("@reach/router");
        function u(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function s(e, t, l) {
        ...
        class d extends e.default.Component {
          constructor(...e) {
            super(...e),
              s(this, "state", {
                loading: !0,
              ...
              s(this, "adopt", () => (0, n.navigate)(this.state.url)),
              s(this, "toggleModal", (e, t) => {
                this.setState(
                  e => {
                    if (4 === this.state.counter)
                      return this.setState(e => ({
                        counter: 0,
                        theme: e.colors[0],
                        showModal: !e.showModal
                      }));
                    const l = this.state.counter + 1;
                    return t === this.state.colors[l]
                      ? {
                          theme: e.colors[e.counter],
                          counter: e.counter + 2,
                          showModal: !e.showModal
                        }
                      : {
          ...
          componentDidMount() {
            t.default.animal(this.props.id).then(({ animal: e }) => {
              this.setState({
                name: e.name,
                animal: e.type,
          ...
          render() {
            if (this.state.loading)
              return e.default.createElement("h1", null, "loading ...");
            const {
              animal: t,
              breed: a,
              location: n,
            ...
            return e.default.createElement(
              "div",
              { className: "details" },
              e.default.createElement(l.default, { media: d }),
              e.default.createElement(
                "div",
                null,
                e.default.createElement("h1", null, s),
                e.default.createElement("h2", null, `${t} - ${a} - ${n}`),
                e.default.createElement(r.default.Consumer, null, ([t, l]) =>
                  e.default.createElement(
                    "button",
                    {
                      style: { backgroundColor: t },
                      onClick: () => this.toggleModal(l, t)
                    },
                    "Adopt ",
                    s
                  )
                ...
                this.state.showModal
                  ...
                  : null,
                e.default.createElement("p", null, u)
              )
            );
          }
        }
    ...
    lY9v: [
      function(require, module, exports) {
        ...
        var e = c(require("react")),
          ...
          r = l(require("./SearchParams")),
          u = require("@reach/router"),
          a = l(require("./Details")),
          n = l(require("./ThemeContext"));
        function l(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function o() {
          ...
          return e.default.createElement(
            ...
            e.default.createElement(
              ...
              e.default.createElement(
                "header",
                null,
                e.default.createElement(u.Link, { to: "/" }, "Adopt Me!"),
                e.default.createElement("h1", null, " Adopt me!")
              ),
              e.default.createElement(
                u.Router,
                null,
                e.default.createElement(a.default, { path: "/details/:id" }),
                e.default.createElement(r.default, { path: "/" })
              )
            )
          );
        };
